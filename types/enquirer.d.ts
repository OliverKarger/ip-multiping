...
declare namespace Enquirer {
    ...
    export namespace Prompt {
        ...
        export type Question<T extends types.Answer = string, P extends Prompt<T> = Prompt<T>> = {
            ...
            skip?:
                | boolean
                | ((this: P, name: string | undefined, value: string | undefined) => boolean | Promise<boolean>);
            show?: boolean;
    ...
    export namespace AutoComplete {
        export type Question<T extends types.Answer, P extends AutoComplete = AutoComplete> = ArrayPrompt.Question<
            T,
            P
        > & {
            suggest?: (
