...
declare namespace Enquirer {
	...
	export namespace types {
		...
		export type ArrayPrompt<T extends types.Answer> =
			Enquirer.ArrayPrompt<T>;
	}
	...
	export namespace Prompt {
		...
		> = {
			...
			timers?: Record<
				string,
				number | {interval?: number; frames: any[]}
			>;
			type?: string | (() => string);
			value?: T;
			validate?: (value: T) => boolean;
